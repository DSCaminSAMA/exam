...
import com.thoughtworks.exam.domain.exam.ExamPaperQuestionItemObject;
import com.thoughtworks.exam.domain.exam.ExamPaperTitleItemObject;
import com.thoughtworks.exam.domain.other.KeyValue;
import com.thoughtworks.exam.repository.ExamPaperMapper;
import com.thoughtworks.exam.repository.QuestionMapper;
...
import com.thoughtworks.exam.service.enums.ActionEnum;
import com.thoughtworks.exam.utility.DateTimeUtil;
import com.thoughtworks.exam.utility.ExamUtil;
...
import com.thoughtworks.exam.viewmodel.admin.exam.ExamPaperTitleItemVM;
...
public class ExamPaperServiceImpl extends BaseServiceImpl<ExamPaper> implements ExamPaperService {
    ...
    @Override
    public String selectTextContent(Integer id) {
        return examPaperMapper.selectTextContent(id);
    }

    @Override
    public Map<String,Object> getTextContent(Integer ids) {
        return examPaperMapper.getTextContent(ids);
    }
}
